...
For each lineage (using odd recombinant genomes) count the number of erased
...
def setup_blastdbs():
    ...
    basedir = join(projdir,"results/erased-alignments/")
...
def main():
    ...
    ## Usage: python align_erased_mutations.py
    proj_dir = "/Users/Rohandinho/Desktop/Projects/STLE-analysis/"
    fasta_base = join(proj_dir,"results/erased-alignments/")
